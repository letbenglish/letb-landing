...
export default function LetBLanding() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans',sans-serif", color: "#1e1e1e", overflowX: "hidden" }}>
      ...
      {/* EXPANSÃO */}
      <section style={{ background:"#1e1e1e",padding:"80px 24px",overflow:"hidden" }}>
        <div className="mx">
      ...
      <section id="metodo" className="sp" style={{ background:"#f4f2df" }}>
        <div className="mx">
          ...
          <div style={{ display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:20,marginTop:64 }} className="g4">
            {[
              { selo:"/brand/selo-livros-verde.png",title:"Reading",desc:"Textos bíblicos reais no seu nível. Vocabulário que cresce a partir de histórias que importam.",color:"#fc5e2d" },
              { selo:"/brand/selo-fone-amarelo.png",title:"Listening",desc:"Áudio nativo e imersão guiada. Seu ouvido aprende a decodificar inglês naturalmente.",color:"#ffba31" },
              { selo:"/brand/selo-talk-azul.png",title:"Speaking",desc:"Abordagem conversation-first. Você fala desde o primeiro dia, com propósito e confiança.",color:"#4caa49" },
              { selo:"/brand/selo-coracao-amarelo.png",title:"Living",desc:"O inglês se torna parte da sua identidade. Não uma matéria, mas uma forma de ver o mundo.",color:"#284684" },
            ].map((p,i)=>(
              <Reveal key={i} delay={.08*i}>
                <div className="ch" style={{ background:"#f4f2df",borderRadius:20,padding:28,border:"1px solid rgba(30,30,30,.06)",height:"100%" }}>
                  <img src={p.selo} alt="" style={{ width:56,height:"auto",display:"block" }} />
      ...
      <section id="experiencia" className="sp" style={{ background:"#f4f2df" }}>
        <div className="mx">
          ...
          <div style={{ display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:22 }} className="g3">
            {[
              { selo:"/brand/selo-pessoa-laranja.png",title:"Mentoria Particular",desc:"1 hora por semana, 100% individual. Não é algoritmo, não é chatbot. É uma pessoa que conhece seu nome, seu nível e seus objetivos.",color:"#fc5e2d",dark:true },
              { selo:"/brand/selo-livros-verde.png",title:"Plataforma Interativa",desc:"Materiais didáticos, ebooks, workbooks e exercícios disponíveis pra você acessar quando quiser. Tudo baseado na metodologia Let B.",color:"#284684" },
              { selo:"/brand/selo-fone-amarelo.png",title:"Áudio Nativo",desc:"Conteúdo gravado por falantes nativos. Imersão real pro seu ouvido, construída ao redor de narrativas bíblicas.",color:"#ffba31" },
              { selo:"/brand/selo-estrela-laranja.png",title:"Flashcards Inteligentes",desc:"Repetição espaçada com vocabulário bíblico. Palavras que você vai usar de verdade, revisadas no intervalo certo.",color:"#4caa49" },
              { selo:"/brand/selo-smile-azul.png",title:"Prática de Conversação",desc:"Espaço seguro pra praticar, errar e crescer. Sem julgamento, só progresso real na comunicação.",color:"#fc5e2d" },
              { selo:"/brand/selo-bussola-laranja.png",title:"Assistência Pedagógica",desc:"Acompanhamento do seu progresso, ajuste de rota e suporte contínuo. Você nunca caminha sozinho na Let B.",color:"#ffba31" },
            ].map((it,i)=>(
              <Reveal key={i} delay={.08*i}>
                <div className="ch" style={{ borderRadius:20,padding:32,background:it.dark?"#1e1e1e":"rgba(30,30,30,.03)",color:it.dark?"#f4f2df":"#1e1e1e",border:it.dark?"none":"1px solid rgba(30,30,30,.05)",height:"100%",position:"relative",overflow:"hidden" }}>
                  ...
                  <img src={it.selo} alt="" style={{ width:56,height:"auto",display:"block" }} />
